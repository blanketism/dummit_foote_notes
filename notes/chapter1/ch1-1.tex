...
\begin{proofnum}
    ...
    To show that $g_1 \star \cdots \star g_n = R(g_1, \ldots, g_n)$, we first show that $R(g_1, \ldots, g_i) \star x = R(g_1, \ldots, g_i, x)$ for any $x \in G$.
    We proceed by induction on $i$.
    The base case $i = 1$ is trivial.
    For $i = 2$, we have $R(g_1, g_2) \star x = (g_1 \star g_2) \star x = g_1 \star (g_2 \star x) = R(g_1, g_2, x)$ by the associativity of $\star$.
